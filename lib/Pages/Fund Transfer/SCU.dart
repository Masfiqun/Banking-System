...
class SCU extends StatelessWidget {
  const SCU({super.key});
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("SCU Account Details", style: GoogleFonts.poppins(fontSize: 14, color: Colors.grey.shade600)),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Frequency", style: GoogleFonts.poppins(fontWeight: FontWeight.w500)),
                Text("One time Transfer", style: GoogleFonts.poppins()),
              ],
            ),
            const SizedBox(height: 20),

            Text("Start From", style: GoogleFonts.poppins(fontWeight: FontWeight.w500)),
            const SizedBox(height: 6),
            TextFormField(
            ...
            CustomButton(
              text: 'Next', 
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => FundTransferOverviewPage()));
              }
            )
          ],
        ),
...
class FundTransferOverviewPage extends StatelessWidget {
  const FundTransferOverviewPage({super.key});
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 20),
            const Text(
              'Your SCU On-Us Schedule Transfer is Successful',
              textAlign: TextAlign.center,
